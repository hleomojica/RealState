    ...
    <div class="table-responsive span3">
        <table  class = "table table-bordered">
            ...
            <tbody>
                <?php
                if ($estado_sol) {
                    foreach ($estado_sol as $row) {
                        echo "<tr>\n";

                        echo "<td>\n" . $row['codestado_solicitud'] . "</td>";
                        echo "<td>\n" . $row['nombre'] . "</td>";
                        ?> 
                    <td><a class="btn btn-success btn-xs" href="<?php echo base_url() ?>adminraa/obt_estadosol_edit/<?= $this->cifrar->enc($row['codestado_solicitud']) ?>">
