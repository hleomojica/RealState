    ...
    <div class="table-responsive span3">
        <table  class = "table table-bordered">
            ...
            <tbody>
                <?php
                if ($tipo_san) {
                    foreach ($tipo_san as $row) {
                        echo "<tr>\n";

                        echo "<td>\n" . $row['codtipo_sancion'] . "</td>";
                        echo "<td>\n" . $row['nombre'] . "</td>";
                        echo "<td>\n" . $row['estado'] . "</td>";
                        ?> 
                    <td><a class="btn btn-success btn-xs" href="<?php echo base_url() ?>adminraa/obt_tiposan_edit/<?= $this->cifrar->enc($row['codtipo_sancion']) ?>">
