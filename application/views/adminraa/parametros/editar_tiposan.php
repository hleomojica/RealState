    ...
    <div class="panel panel-primary">
        ...
        <div class="panel-body">
            ...
            <div class="table-responsive span3">
                <form action="<?php echo base_url() ?>adminraa/upd_tiposan" enctype="multipart/form-data" method="post">
                    ...
                    <div class="form-group col-sm-4">
                        ...
                        <select class="form-control" required="" name="codestado_tiposancion">
                             <?php
                            if ($estados) {
                                foreach ($estados as $row) {
                                    ?>
                                    <option value="<?= $row['codestado_tiposancion'] ?>"><?= $row['nombre'] ?></option>
                                    <?php
                                }
                            } else {
                    ...
                    <div class="col-sm-12">
                        <button type="submit" class="btn btn-success centered">Editar</button>
                    </div>
                </form>
                <ul class="pager">
                    <li class="previous">
                        <a href="<?php echo base_url() ?>adminraa/ver_estados">&larr; Atras</a>
                    </li>
                    <li class="next">
