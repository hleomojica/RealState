...
<!------------------------/ASIDE--------------->
    ...
    <div class="col-lg-9">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form class="form col-sm-6" action="<?php echo base_url() ?>adminraa/bus_ava_nombre" method="post">
                ...
                <form class="form col-sm-6" method="post" action="<?php echo base_url() ?>adminraa/bus_ava_estado">
                    <div class="form-group">
                ...
                <table  class = "table table-bordered table-striped">
                    <thead>
                        ...
                        <tbody>
                            ...
                            <td><a class="btn btn-success btn-xs" href="<?php echo base_url() ?>adminraa/obt_detaller_avaluador/<?= $this->cifrar->enc($avaluadores["numero_id"]) ?>">
