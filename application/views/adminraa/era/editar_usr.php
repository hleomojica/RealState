...
<div class="row">
    <div class="col-sm-12">
        <ol class="breadcrumb">
           <li><a href="<?php echo base_url() ?>login/index">Inicio</a></li>
            ...
            <li><a href="<?php echo base_url() ?>adminraa/obtener_usuarios/<?=$this->cifrar->enc($this->session->userdata("codent")); ?>">Usuarios</a></li>
    ...
    <div class="col-lg-9">
        ...
        <div class="panel panel-primary">
            ...
            <div class="panel-body">
                <form action="<?php echo base_url() ?>adminraa/update_usr" enctype="multipart/form-data" method="post">
...
<div class="modal fade" id="modelpass" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>adminraa/upd_pass_usr" enctype="multipart/form-data" method="POST" name="formulario">
