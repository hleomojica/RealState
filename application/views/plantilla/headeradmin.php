                ...
                <div class="collapse navbar-collapse navbar-ex1-collapse">
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url() . "adminraa/ver_avaluadores" ?>">Ver Avaluadores</a></li>
                                <li class="divider"></li>
                    ...
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() . "adminraa/ver_parametros" ?>">Parametros</a></li>
                                <li class="divider"></li>
                                <li><a href="<?php echo base_url() . "adminraa/ver_transacciones" ?>">Auditoria</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                <li><a href="<?php echo base_url() . "adminraa/nuevo_reporte" ?>" >Nuevo reporte</a></li>
                            </ul>
                        </li>
                    </ul>
                    <ul class="nav navbar-nav navbar-right">
                        ...
                        <li class="dropdown">
                            ...
                            <ul class="dropdown-menu">
                                ...
                                <li><a href="<?php echo base_url() . "adminraa/configuracion" ?>">Cambiar Contraseña</a></li>
