    ...
    <div class="panel panel-default">
        ...
        <div class="panel-body">
            <div class="list-group">
                ...
                <hr>
                <a href="<?php echo base_url() . "adminera/configuracion" ?>" class="list-group-item active">Configuración</a>
            </div>
        </div>
    </div>
</div>
...
<div class="modal fade" id="modelpass" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>adminera/upd_pass" enctype="multipart/form-data" method="POST" name="formulario">
                <div class="modal-body">
                    ...
                    <input type="hidden" value="<?= $this->session->userdata("usuario")?>" name="nombreusuario">
...
<div class="modal fade" id="modelusr" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            ...
            <form action="<?php echo base_url() ?>adminera/upd_usr" enctype="multipart/form-data" method="POST" name="formulario">
                <div class="modal-body">
                    <div class="form-group">
